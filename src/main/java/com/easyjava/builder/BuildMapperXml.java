...
public class BuildMapperXml {
    ...
    private static final String BASE_COLUM_LIST = "base_column_list";
    ...
    public static void execute(TableInfo tableInfo) {
        ...
        try {
            ...
            bw.write("\t<sql id=\"" + BASE_COLUM_LIST + "\">");
            bw.newLine();
            ...
            bw.newLine();
            bw.write("\t\tSELECT <include refid=\"" + BASE_COLUM_LIST + "\"/> FROM " + tableInfo.getTableName() + " <include refid=\"" + QUERY_CONDITION + "\"/>");
            bw.newLine();
            ...
            System.out.println(insertFieldBuffer);
            for (FieldInfo fieldInfo : tableInfo.getFieldList()) {
            ...
            for (Map.Entry<String, List<FieldInfo>> entry : keyIndexMap.entrySet()) {
                ...
                bw.newLine();
                bw.write("\t\tselect <include refid=\"" + BASE_COLUM_LIST + "\"/> from " + tableInfo.getTableName() + " where " + paramsNames);
                bw.newLine();
                bw.write("\t</select>");
                bw.newLine();
                bw.newLine();
